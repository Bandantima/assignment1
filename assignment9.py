#Qu1.To what does a relative path refer?
Ans:Relative paths are relative to the current working directory.

#qu2.What does an absolute path start with your operating system?
Ans:Absolute paths start with the root folder, such as / or C:.

#qu3 What do the functions os.getcwd() and os.chdir() do?
Ans:The os.getcwd() function returns the current working directory. The os.chdir() function changes the current working
    directory.

Qu4.What are the . and .. folders?
Ans:The . folder is the current folder, and .. is the parent folder.

#Qu5.In C:\bacon\eggs\spam.txt, which part is the dir name, and which part is the base name?
Ans:C:\bacon\eggs is the dir name, while spam.txt is the base name.

#Qu6. What are the three “mode” arguments that can be passed to the open() function?
Ans:The string 'r' for read mode, 'w' for write mode, and 'a' for append mode.

#Qu7. What happens if an existing file is opened in write mode?
Ans:An existing file opened in write mode is erased and completely overwritten.

#QU8.How do you tell the difference between read() and readlines()?
...
#qu9.What data structure does a shelf value resemble?
